export default {
  ...
  users: {
    ...
    resetPassword: 'Reset Password',
    resetPasswordDescription: 'Reset password for user: {name}',
  ...
  roles: {
    ...
    editRoleDescription: 'Update role and related permissions',
    backToRoles: 'Back to Roles',
    roleInformation: 'Role Information',
    addRoleDescription: 'Add a new role with specific permissions',
    updateRoleDescription: 'Update role and related permissions',
    viewDetails: 'View Details',
