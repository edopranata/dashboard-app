<template>
  <div class="simple-avatar-upload">
    ...
    <div class="upload-actions q-mt-md">
      ...
      <q-btn color="primary" outline :loading="uploading" @click="triggerFileInput" :label="$t('avatar.change_avatar')"
        icon="photo_camera" size="sm" :disable="disabled" />

      <q-btn v-if="currentAvatarUrl && !isDefault" color="negative" outline :loading="deleting" @click="confirmDelete"
        :label="$t('avatar.delete_avatar')" icon="delete" size="sm" class="q-ml-sm" />
    </div>
    ...
    <q-dialog v-model="showDeleteDialog">
      <q-card>
        ...
        <q-card-actions align="right">
          ...
          <q-btn flat :label="$t('common.delete')" color="negative" @click="deleteAvatar" :loading="deleting" />
        </q-card-actions>
      </q-card>
    </q-dialog>
  </div>
